...
public class MainActivity extends AppCompatActivity
    ...
    ArrayList<HashMap<String, String>> gitusercontactList;
    private ListView lv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gitusercontactList = new ArrayList<>();

        lv = (ListView) findViewById(R.id.git_user_recyclerview);
    ...
    private class GetContacts extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            if (jsonStr != null) {
                try {
                    ...
                    JSONArray gitcontacts = jsonObj.getJSONArray("items");
                    ...
                    for (int i = 0; i < gitcontacts.length(); i++) {
                        ...
                        gitusercontactList.add(contact);
                    }
        ...
        protected void onPostExecute(Void result) {
            ...
            listViewAdapter = new ListViewAdapter(getApplicationContext(),gitusercontactList);
